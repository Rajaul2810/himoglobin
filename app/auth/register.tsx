...
const RegisterPage = () => {
  ...
  const userTypes = useMemo(() => [{label: 'Donor', value: 'Donor'},{label: 'Leader', value: 'Volunteer'}], [])
  ...
  const validate = () => {
    ...
    if (formData.UserType === 'Volunteer' && !formData.InstituteName) newErrors.InstituteName = 'Institute name is required'
