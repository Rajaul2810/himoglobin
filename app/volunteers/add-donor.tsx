...
const AddDonor  = () => {
  ...
  const {mutate: register, isPending} = useMutation({
    ...
    onError: (error) => {
      console.log(error);
      Alert.alert('Error', 'Donor adding failed. Please try again.');
    }
  })
  ...
  return (
    <>
    <Stack.Screen options={{headerTitle: "Add Donor"}} />
      <SafeAreaView style={{flex: 1}}>
      <ScrollView>
        <ThemedView style={styles.formContainer}>
          <ThemedText type='title' style={styles.title}>Add Donor</ThemedText>
